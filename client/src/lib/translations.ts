...
export const translations = {
  ...
  ar: {
    ...
    // SEO Content Section
    seoTitle: 'تحميل فيديوهات TikTok - أداة مجانية عبر الإنترنت',
    seoSubtitle: 'خدمة احترافية لتحميل فيديوهات TikTok',
    whyChooseUs: 'لماذا تختار منزّل TikTok الخاص بنا؟',
    
    // Main features for SEO
    unlimitedDownloads: 'تحميلات مجانية غير محدودة',
    unlimitedDownloadsDesc: 'حمّل أي عدد تريده من فيديوهات TikTok بدون أي قيود. خدمتنا المجانية ليس بها حدود يومية أو اشتراكات مدفوعة مطلوبة.',
    
    allFormatsSupported: 'جميع صيغ الفيديو مدعومة',
    allFormatsSupportedDesc: 'حمّل فيديوهات TikTok بصيغة MP4، احفظ صوت TikTok بصيغة MP3، واحصل على المحتوى بجودة عالية أو عادية حسب الرفع الأصلي.',
    
    noSoftwareRequired: 'لا حاجة لتثبيت برامج',
    noSoftwareRequiredDesc: 'منزّلنا المبني على الويب يعمل مباشرة في متصفحك. لا حاجة لتحميل تطبيقات أو تثبيت إضافات على جهازك.',
    
    crossPlatformCompatibility: 'يعمل على جميع الأجهزة',
    crossPlatformCompatibilityDesc: 'متوافق مع ويندوز وماك ولينكس وأندرويد وآي أو إس. حمّل فيديوهات TikTok على الكمبيوتر أو الجهاز اللوحي أو الجوال بسهولة.',
    
    fastProcessing: 'معالجة سريعة البرق',
    fastProcessingDesc: 'خوادمنا المحسّنة تعالج وتحوّل فيديوهات TikTok في ثوانٍ. اختبر أسرع خدمة تحميل فيديوهات TikTok المتاحة عبر الإنترنت.',
    
    privacySecure: 'الخصوصية والأمان أولاً',
    privacySecureDesc: 'لا نحفظ فيديوهاتك المحمّلة أو معلوماتك الشخصية. جميع تحميلات فيديوهات TikTok تتم معالجتها بأمان وحذفها تلقائياً.',
    ...
    step3Desc: 'اختر جودة الفيديو المفضلة لديك (عالية، عادية، أو صوت فقط) وانقر على تحميل.',
    
    // Advanced features
    advancedFeatures: 'ميزات متقدمة لتحميل TikTok',
    batchDownload: 'دعم التحميل المتعدد',
    batchDownloadDesc: 'حمّل عدة فيديوهات TikTok مرة واحدة عبر لصق عدة روابط.',
    ...
    thumbnailDownloadDesc: 'حمّل صور مصغرة لفيديوهات TikTok وصور المعاينة بدقة عالية.',
    
    // About page
    aboutUs: 'من نحن',
    aboutDesc: 'TikDownloader هو منزّل فيديوهات TikTok المجاني الرائد عبر الإنترنت الذي يثق به ملايين المستخدمين حول العالم.',
    ourMission: 'مهمتنا',
    missionDesc: 'نؤمن أن الجميع يجب أن يكون لديهم وصول سهل لتحميل وحفظ محتوى TikTok المفضل لديهم. مهمتنا هي توفير خدمة سريعة وآمنة وسهلة الاستخدام تعمل على جميع الأجهزة.',
    ourValues: 'قيمنا',
    ...
    cookiesDesc: 'نستخدم ملفات تعريف الارتباط لتحسين تجربة التصفح وتذكر تفضيلاتك. يمكنك تعطيلها في إعدادات متصفحك.',
    thirdParty: 'خدمات الطرف الثالث',
    thirdPartyDesc: 'قد نستخدم خدمات الطرف الثالث للتحليلات والإعلان. لهذه الخدمات سياسات خصوصية خاصة بها.',
    yourRights: 'حقوقك',
    ...
    // Terms of Service
    termsOfServiceDesc: 'الرجاء قراءة هذه الشروط بعناية قبل استخدام خدمتنا. باستخدام TikDownloader، توافق على هذه الشروط.',
    ...
    intellectualPropertyDesc: 'يجب على المستخدمين احترام حقوق الملكية الفكرية لمنشئي المحتوى و TikTok. المحتوى المحمّل يجب أن يُستخدم للأغراض الشخصية فقط.',
    disclaimer: 'إخلاء المسؤولية',
    disclaimerDesc: 'يتم توفير TikDownloader "كما هو" بدون ضمانات. لسنا مسؤولين عن المحتوى المحمّل عبر خدمتنا.',
    limitationOfLiability: 'تحديد المسؤولية',
    limitationOfLiabilityDesc: 'لن يكون TikDownloader مسؤولاً عن أي أضرار مباشرة أو غير مباشرة أو تبعية ناشئة من استخدام خدمتنا.',
    modifications: 'التعديلات',
    modificationsDesc: 'نحتفظ بالحق في تعديل هذه الشروط في أي وقت. الاستخدام المستمر يشكل قبولاً للشروط المعدّلة.',
    
    // FAQ Page
    faqPageDesc: 'اعثر على إجابات للأسئلة الأكثر شيوعاً حول TikDownloader.',
    faqQ7: 'هل يوجد حد لتحميل الفيديوهات؟',
    faqA7: 'لا، خدمتنا مجانية تماماً مع تحميلات غير محدودة. يمكنك تحميل أي عدد تريده من فيديوهات TikTok.',
    faqQ8: 'هل تحفظون الفيديوهات المحمّلة؟',
    faqA8: 'لا، لا نحفظ أي فيديوهات محمّلة على خوادمنا. كل المعالجة تتم مؤقتاً والملفات تُحذف تلقائياً.',
    faqQ9: 'هل يمكنني تحميل فيديوهات TikTok خاصة؟',
    faqA9: 'لا، يمكنك تحميل فيديوهات TikTok المتاحة للعموم فقط. الفيديوهات الخاصة لا يمكن الوصول إليها أو تحميلها.',
    faqQ10: 'ما هي جودات الفيديو المتاحة؟',
    faqA10: 'ندعم التحميل بجودة عالية (1080p)، عادية (720p)، وصوت فقط حسب جودة الفيديو الأصلي.',
    stillHaveQuestions: 'لا تزال لديك أسئلة؟',
    stillHaveQuestionsDesc: 'لا تجد ما تبحث عنه؟ اتصل بفريق الدعم للحصول على مساعدة شخصية.',
    ...
    downloadOtherAudios: 'تحميل ملفات صوت أخرى',
    clear: 'مسح',
    pleaseWait: 'الرجاء الانتظار...',
    downloadOptionsWillAppear: 'خيارات التحميل ستظهر خلال لحظة',
    videoReady: 'فيديو TikTok جاهز',
  ...
  // Additional languages use English translations as fallback
  it: { 
    brand: 'TikDownloader',
    features: 'Features',
    faq: 'FAQ',
    ...
    fastProcessing: 'Lightning Fast Processing',
    fastProcessingDesc: 'Our optimized servers process and convert TikTok videos in seconds.',
    privacySecure: 'Privacy & Security First',
    privacySecureDesc: 'We dont store your downloaded videos or personal information.',
    howItWorks: 'How It Works',
    howItWorksDesc: 'Download TikTok videos in 3 simple steps',
    step1Title: 'Copy URL',
    step1Desc: 'Copy the TikTok video link you want to download',
    step2Title: 'Paste & Analyze',
    step2Desc: 'Paste the URL into our tool and click analyze',
    step3Title: 'Download',
    step3Desc: 'Choose quality and download your video',
    advancedFeatures: 'Advanced Features',
    batchDownload: 'Batch Download',
    batchDownloadDesc: 'Download multiple videos at once',
    audioExtraction: 'Audio Extraction',
    audioExtractionDesc: 'Extract audio from TikTok videos',
    thumbnailDownload: 'Thumbnail Download',
    thumbnailDownloadDesc: 'Download video thumbnails in high quality',
    faqTitle: 'Frequently Asked Questions',
    faqQ1: 'How to download TikTok videos without watermark?',
    faqA1: 'Simply paste the TikTok video URL into our tool and click download.',
    faqQ2: 'Is it legal to download TikTok videos?',
    faqA2: 'Yes, for personal use it is generally legal.',
    faqQ3: 'What video qualities are supported?',
    faqA3: 'We support HD, SD, and original quality.',
    faqQ4: 'Do I need to install any software?',
    faqA4: 'No, our tool works directly in your browser.',
    faqQ5: 'Is there a limit to how many videos I can download?',
    faqA5: 'No, you can download unlimited videos for free.',
    faqQ6: 'Can I download TikTok videos on my iPhone/Android?',
    faqA6: 'Yes, our tool works on all devices.',
    ...
    legal: 'Legal',
    support: 'Support',
    footerDesc: 'The best online TikTok video downloader.',
    ...
    stillHaveQuestions: 'Still Have Questions?',
    stillHaveQuestionsDesc: 'Cannot find what you are looking for? Contact our support team.',
    tikTokVideoDownloader: 'TikTok Video Downloader',
    instagramDownloader: 'Instagram Downloader',
    youTubeDownloader: 'YouTube Downloader',
    twitterVideoDownloader: 'Twitter Video Downloader',
    snapchatDownloader: 'Snapchat Downloader',
    allRightsReserved: 'All rights reserved',
    notAffiliatedDisclaimer: 'Not affiliated with TikTok Inc.',
    aboutDesc: 'TikDownloader is the leading free online TikTok video downloader trusted by millions.',
    ourMission: 'Our Mission',
    missionDesc: 'We believe everyone should have easy access to download their favorite TikTok content.',
    ourValues: 'Our Values',
    value1: 'Free and unlimited downloads for everyone',
    value2: 'Privacy and security first approach',
    value3: 'No software installation required',
    ...
    reliableServiceDesc: '99.9% uptime with servers optimized for fast video processing.',
    getStarted: 'Ready to Get Started?',
    getStartedDesc: 'Join millions of users who trust TikDownloader.',
    startDownloading: 'Start Downloading Now',
    contactDesc: 'Have questions or need support? We are here to help.',
    getInTouch: 'Get in Touch',
    email: 'Email',
    liveChat: 'Live Chat',
    liveChatDesc: 'Available 24/7 for instant support',
